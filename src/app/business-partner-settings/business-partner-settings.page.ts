...
@Component({
  ...
  templateUrl: './business-partner-settings.page.html',
  styleUrls: ['./business-partner-settings.page.scss'],
})
export class BusinessPartnerSettingsPage implements OnInit {
