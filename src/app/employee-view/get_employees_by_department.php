...
// Verificar si se han pasado los parámetros necesarios (company_id y department_id)
if (!isset($_GET['company_id']) || !isset($_GET['department_id'])) {
    echo json_encode(['success' => false, 'error' => 'company_id and department_id are required']);
    exit;
}
